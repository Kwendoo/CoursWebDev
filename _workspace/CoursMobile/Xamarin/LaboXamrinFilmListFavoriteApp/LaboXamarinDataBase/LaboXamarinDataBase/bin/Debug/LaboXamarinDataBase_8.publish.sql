...
GO
PRINT N'Modification de Table [dbo].[Movie]...';


GO
ALTER TABLE [dbo].[Movie] ALTER COLUMN [PosterURL] VARCHAR (MAX) NOT NULL;
...
GO
ALTER TABLE [dbo].[Person] ALTER COLUMN [PictureURL] VARCHAR (MAX) NOT NULL;
