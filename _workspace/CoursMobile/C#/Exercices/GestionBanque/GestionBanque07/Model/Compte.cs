...
{
    public abstract class Compte : ICustumer, IBanker
    {
        ...
        {
            return Solde + ((c.Solde < 0) ? 0.0 : c.Solde); // Ceci est un opérateur ternaire et permet de racourcir un if : ((si X est <>= à Y) ? Alors Z : sinon W)
        }
