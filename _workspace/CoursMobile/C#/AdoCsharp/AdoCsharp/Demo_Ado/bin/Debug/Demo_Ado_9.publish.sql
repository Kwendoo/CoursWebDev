/*
Script de déploiement pour Script_postDeployment
...
GO
:setvar DatabaseName "Script_postDeployment"
:setvar DefaultFilePrefix "Script_postDeployment"
...
CREATE TABLE [dbo].[Employee] (
    ...
    CONSTRAINT [UK_Employee_Email] UNIQUE NONCLUSTERED ([Email] ASC)
);


GO
PRINT N'Création de Index [dbo].[Employee].[IX_Employee_Email]...';
...
GO
PRINT N'Création de Contrainte par défaut [dbo].[DF_Employee_Active]...';
...
GO
PRINT N'Création de Clé étrangère [dbo].[FK_Employee_Employee]...';
...
GO
PRINT N'Création de Contrainte de validation [dbo].[CK_Employee_LastName]...';


GO
ALTER TABLE [dbo].[Employee]
    ADD CONSTRAINT [CK_Employee_LastName] CHECK (LEN(RTRIM(LTRIM([LastName]))) > 0);


GO
PRINT N'Création de Contrainte de validation [dbo].[CK_Employee_FirstName]...';


GO
ALTER TABLE [dbo].[Employee]
    ADD CONSTRAINT [CK_Employee_FirstName] CHECK (LEN(RTRIM(LTRIM([FirstName]))) > 0);


GO
PRINT N'Création de Déclencheur [dbo].[TG_Employee_Delete]...';
...
CREATE TRIGGER [dbo].[TG_Employee_Delete]
    ...
    END
GO
PRINT N'Création de Vue [dbo].[V_Employe]...';
...
GO
PRINT N'Création de Procédure [dbo].[CSP_AddEmployee]...';
