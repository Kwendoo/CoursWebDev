...
CREATE TABLE [dbo].[tmp_ms_xx_Section] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_Section1] PRIMARY KEY CLUSTERED ([Id] ASC)
);
...
EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK_Section1]', N'PK_Section', N'OBJECT';
...
GO
PRINT N'Actualisation de Procédure [dbo].[AddSection]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[AddSection]';
